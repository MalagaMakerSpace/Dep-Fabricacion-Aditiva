...
#define STRING_CONFIG_H_AUTHOR "(Idir)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR2-D2"
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 47.75  // X offset: -left  +right  [of the nozzle]
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 30 //((Y_BED_SIZE) / 2)    // Y point for Z homing when homing all axes (G28).
#endif
